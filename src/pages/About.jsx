        ...
        >
          <div className="h-full rounded-[15px] bg-white p-6 dark:bg-zinc-950">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              ...
              <Link
                to="/updates"
                className="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-800 transition hover:border-brand-400 dark:border-zinc-600 dark:text-zinc-100"
              >
                See updates
              </Link>
            </div>
